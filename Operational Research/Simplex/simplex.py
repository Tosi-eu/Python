...
class Simplex:
    ...
    def pivot_on(self, table, pivot_row, pivot_col):
        """
        Realiza operações de pivoteamento na tabela, com base no elemento pivô.
        """
    ...
    """
    Os três próximos métos são utilizadas para visualização. No caso, o primeiro método grava em arquivo a tabela simplex atual, o segundo método
    formata os coeficientes que estão sendo utilizados a cada iteração e o terrceiro método grava em arquivo os cálculos que estão sendo feitos
    """
...
if __name__ == "__main__":
    ...
    base_output_dir = os.path.join("artifacts", "output") #pasta com  os artefatos
